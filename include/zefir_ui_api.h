...
#define ZEFIR_CALLCONV WINAPI
#define ZEFIR_CALLBACK ZEFIR_CALLCONV

#define ZEFIR_EXPORT __declspec(dllexport)
#define ZEFIR_IMPORT __declspec(dllimport)
#define ZEFIR_DLL ZEFIR_IMPORT

#define ZEFIR_API(type) ZEFIR_DLL type ZEFIR_CALLCONV
...
typedef struct {
    ...
    Zefir_Optional_ZefirCallback m_renderPopup;
} Zefir_ButtonData;
...
typedef struct {
    ...
    Zefir_Optional_ZefirCallback m_onHotkeySet;
    Zefir_Optional_ZefirCallback m_renderPopup;
    Zefir_Optional_String m_popupTitle;
    Zefir_Optional_Float m_popupWidth;
} Zefir_CheckboxData;
...
typedef struct {
    ...
    Zefir_Optional_PBool m_value;
    Zefir_Optional_PUInt8 m_key;
    Zefir_Optional_String m_info;
    Zefir_Optional_PImFont m_customInfoFont;
    Zefir_Optional_ZefirCallback m_onActivate;
    Zefir_Optional_ZefirCallback m_onColorPick;
    Zefir_Optional_ZefirCallback m_onHotkeySet;
    Zefir_Optional_ZefirCallback m_renderPopup;
    Zefir_Optional_String m_popupTitle;
    Zefir_Optional_Float m_popupWidth;
...
#define ZEFIR_CREATE_DECLARATION_HELPER(rtype, name, ...) \
     typedef rtype (ZEFIR_CALLCONV* ZEFIR_CREATE_CONCAT(name, _t))(__VA_ARGS__); ZEFIR_CREATE_CONCAT(name, _t) name = 0;
 ...
 *        - Zefir_Optional_ZefirCallback m_renderPopup: Optional extra render callback
 *
